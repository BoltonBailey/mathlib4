...
(bundling the definition of TM2 in `WangB.lean`), a definition of when a TM gives a certain
...
the namespace `Turing.TM2` in `WangB.lean`), with an input and output stack,
